...
* issue 1: one goalie has 400 saves out of 500 shots, another has 4 saves out of 5 shots. They have the same "SV%", but are they equally good? In the former case, we have more information and data points to deduce the true ability of the goalie. In the latter case, there are many uncertainties: we simply do not have enough data to conclude how good the player actually is.
* issue 2: while 400 saves out of 500 shots should be more impressive than 4 saves out of 5 shots, is it more impressive than 80 saves out of 100 shots? And they might some goalie getting only 100 shots? In fact, the “SV%” metric ignores the strengths of the teams. Goalies who are in the more dominating teams may receive less shots, thanks to better defence players, and better pressure created by the forwards against the other teams. "The best defence is attack". Even if SV% is similar, the **"general difficulty"** could be very different. For example, in season 2017, Casey DeSmith (whose team ranked 2nd in its division) appeared 700:09 minutes, and had a SV% of 92.1%; Laurent Brossoit (whose team  ranked 6th in its division) appeared 740:14 minutes, and had a SV% of 88.3%. The SV%'s are similar, but Casey DeSmith allowed 2.40 goals per 60 minutes on average, while Laurent Brossoit allowed 3.24 goals per 60 minutes. The overall team performances are vast different.
...
* feature 1: in response to *issue 1*, I propose creating a new feature by multiplying the ‘SV%’ by a scaling term. The scaling term should have a shape like the log function, so that the performance is multiplied by a small amount when the number of games played are small but decrease rapidly when the games played increase to a certain amount. In the end, 4 saves out of 5 shots will be less impressive than 400 saves out of 500 shots.
* feature 2: we can divide the ‘%SV’ by ‘Goals allowed average’ to “normalize” performance. I propose this to reflect the fact that goalies in the weaker team have to work with weaker defence players and weaker forwards that are incapable of putting pressure against the other team. This proposal will favor the goalies in a weaker team who have consistent performance.
